...
/* eslint-disable */
// js file that we integrate into our html and runs on client side
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoidmlwcy1tMTAiLCJhIjoiY2toOHR1MXNiMHpkejJwbnpsazAyeTN4bSJ9.sOLHxSL8GksnVjs_ZCKktg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/vips-m10/ckh8u8mgs13oj19lllxikviz8',
...
var showAlert = function showAlert(type, message) {
  ...
  window.setTimeout(hideAlert, 5000); // hide all alerts after 5 seconds
};
...
var stripe = Stripe('pk_test_51HnP91JKbWQ6AUfFJL6d2YvHZNPWvmej5O0Q2v3tpWBEQfKcuCWvIRqmflvpuAFHiwXstZgftT0kAQG7PF38a6HE0060y4Pxuq'); //pass in public key
...
var bookBtn = document.getElementById('book-a-tour'); // VALUES
// DELEGATION
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(); //recreating multipart/form-data programatically

    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]);
    console.log(form);
    (0, _updateSettings.updateSettings)(form, 'data'); // const email = document.getElementById('email').value;
